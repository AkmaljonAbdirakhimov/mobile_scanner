...
abstract class MobileScannerPlatform extends PlatformInterface {
  ...
  /// Get the stream of credit card captures.
  Stream<CreditCardCapture?> get creditCardsStream {
    throw UnimplementedError('creditCardsStream has not been implemented.');
  }
  ...
  ///
  /// The [path] is the path to the file on disk.
  /// The [confidenceThreshold] specifies the minimum confidence score for detection.
  ///
  /// Returns the credit cards that were found in the image.
  Future<CreditCardCapture?> analyzeImageForCreditCards(String path, {double confidenceThreshold = 0.7}) {
    throw UnimplementedError('analyzeImageForCreditCards() has not been implemented.');
  }
