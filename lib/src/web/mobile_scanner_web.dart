...
class MobileScannerWeb extends MobileScannerPlatform {
  ...
  /// The stream controller for the credit card stream.
  ...
  @override
  Stream<CreditCardCapture?> get creditCardsStream => _creditCardsController.stream;
  ...
  Future<CreditCardCapture?> analyzeImageForCreditCards(String path, {double confidenceThreshold = 0.7}) {
    throw UnsupportedError('analyzeImageForCreditCards() is not supported on the web.');
  }
